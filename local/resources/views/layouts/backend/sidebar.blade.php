                ...
                <div class="menu-inner">
                    <nav>
                        ...
                        @if(Auth::user()->role != 'customer')
                            ...
                            <li @if(Request::segment(1)=='sub_category' ) class="active" @endif>
